...
<head>
        ...
        <header class="intro">
          <div class="intro-body">
            <div class="container">
              <div class="row">
                <div class="col-md-8 col-md-offset-2">
                  <h1 class="brand-heading">Discover a Project</h1>
                </div>
              </div>
            </div>
            <hr>
            ...
            <div class="project-images">
              <?php
              $query= "SELECT image, name FROM category";
              ...
              while ($row = pg_fetch_array($result)){
                ...
                <div class = "col-md-3">
                  <div class="view view-first">  
                    <img src=<?php echo $row[0];?> class="thumbnail">
                    <div class="mask">  
                     <h2><?php echo $row[1];?></h2>  
                     <br>
                     <a href=<?php echo 'category.php?category=' . strtolower($row[1]); ?> class="info">Learn More</a>  
                   </div>  
                 </div>
               </div>
  ...
  <!-- Google Maps API Key - Use your own API key tos enable the map feature. More information on the Google Maps API can be found at https://developers.google.com/maps/ -->
