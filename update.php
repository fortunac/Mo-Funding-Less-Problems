  ...
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--[if lt IE 9]>
      ...
      <body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <!--SIMULATED DATA: FILL IN WITH 8 OR MORE RANDOM ONES-->
        <!-- THE READ MORE BUTTONS SHOULD REDIRECT TO THE DETAIL PAGE WITH DETAILS ALL FILLED IN-->
        ...
        <header class="intro">
          <div class="intro-body">
            <div class="container">
              <div class="row">
                <div class="col-md-8 col-md-offset-2">
                  <h1 class="brand-heading">Edit a Project</h1>
                </div>
              </div>
            </div>
            ...
            $project = intval($_GET['pid']);
            echo $project; 

            $projectQuery = "SELECT pr.title, pr.goalamount, pr.description, pr.image 
            FROM project pr 
            WHERE pr.id = " . $project . ";";
            ...
            <div class = "row">
              ...
              <div class = "col-md-4 align-left">
                ...
                <form action = "update-project.php" method = "get">
                  <text class = "data-entry to-black">New Project Name:  </text>
                  <input type="text" name="new-project-name" class = "searchbar to-black" id = "new-project-name" value= <?php echo '"' . $row[0] . '"'; ?>>
                  <br>
                  <br>
                  <text class = "data-entry to-black">New Project Category:  </text>
                  <select name = "category" id = "category" class = "to-black">
                   <?php
                   ...
                   while($line = pg_fetch_array($result, null, PGSQL_ASSOC)){
                     foreach ($line as $col_value) {
                      echo "<option value=\"".$col_value."\" class = 'to-black'>".$col_value."</option>";
                    }
                  }
                  ?>
                </select>
                ...
                <text class = "data-entry to-black">Add Project Category:  </text>
                <select name = "category2" id = "category2" class = "to-black">
                 <?php
              ...
              <input type = "radio" name = "add-category1" id = "add-category1"><text class = "data-entry to-black">Add new category.</text>
              <br><br>



              <text class = "data-entry to-black">Add Project Category:  </text>
              <select name = "category3" id = "category3" class = "to-black">
               <?php
            ...
            <input type = "radio" name = "add-category2" id = "add-category2"><text class = "data-entry to-black">Add new category.</text>
            <br>




            <text class = "data-entry to-black">New Project Description:  </text>
            <input type="text" name="new-project-description" class = "searchbar to-black" id = "new-project-description" value=<?php echo '"' . $row[2] . '"'; ?>>
            <br>
            <text class = "data-entry to-black">New Amount of Money Needed:  </text>
            <input type="text" name="new-project-money" class = "searchbar to-black" id = "new-project-money" value=<?php echo '"' . $row[1] . '"'; ?>>
            <br>
            <br>
            <text class = "data-entry to-black">New Image:  </text>
            <input type="file" name="new-project-image" id = "new-project-image">
            <input type = "radio" name = "update-image" id = "update-image"><text class = "data-entry to-black">Select to upload new image.</text>
            <br><br>
            <input type = "hidden" name = "pid" id = "pid" value = <?php echo "'" .  intval($_GET['pid']) . "'"; ?>>
            <input type = "submit" class = "own-project-button">
          </form>
          <form action = "delete.php" method="get">
           <input type = "hidden" name = "pid" id = "pid" value = <?php echo "'" .  intval($_GET['pid']) . "'"; ?>>
           <br>                 
           <input type = "submit" class = "own-project-button" value ="Delete Project">
         </form>
         <br>
         <br>
       </div>
    ...
    <div class="modal-content modal-custom">
      ...
      <div class="modal-body">
        <form action="login.php" method="post">
          ...
          <br>
          <br>
          <input type ="hidden" name = "url" value ="index.php" id = "url">
          <input type="submit" class="own-project-button">
        </form>
      </div>
