...
<head>
  ...
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
             <form action="results.php" method="get">
              ...
              <li>
                <input type="text" name="searchparameter" class = "searchbar" id ="search-text" placeholder=" Basic Search">   
    ...
    if(isset($category)) {
      ...
      <!--SIMULATED DATA: ADD IN REAL-->

      <?php
      $query= "SELECT p.image, p.title, p.duration, p.currentAmount, p.goalAmount - p.currentAmount, p.id
      FROM project p, category c, projectCategory pc
      WHERE p.id = pc.project
      ...
      while ($row = pg_fetch_array($result)) {
        ...
        <div class = "row search-results-labels">
          ...
          <div class = "col-md-2"><?php echo $row[1];?>
          </div>
        ...
        <div class="modal-content modal-custom">
          ...
          <div class="modal-body">
            <form action="login.php" method="post">
              ...
              <br>
              <br>
              <input type ="hidden" name = "url" value =<?php echo '"category.php?category=' . $category . '"';?> id = "url">
