          ...
          <div class="intro-body">
            <div class="container">
              <div class="row">
                <div class="col-md-8 col-md-offset-2">
                  <h1 class="brand-heading">Advanced Search</h1>
                </div>
              </div>
            </div>
            ...
            <div class = "row">
              ...
              <div class = "col-md-4 align-left">
                <br>
                <form action = "advanced-search-results.php" method = "get">
                  <text class = "data-entry to-black">Project Name:  </text>
                  <input type="text" name="project-name" class = "searchbar to-black" id = "project-name">
                  <br>
                  <text class = "data-entry to-black">Project Host's Name:  </text>
                  <input type="text" name="project-host" class = "searchbar to-black" id = "project-host">
                  <br>
                  <text class = "data-entry to-black">Project Category:  </text>
                  <input type="text" name="project-category1" class = "searchbar to-black" id = "project-category1">
                  <br>
                  <text class = "data-entry to-black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</text>
                  <input type="text" name="project-category2" class = "searchbar to-black" id = "project-category2">
                  <br>
                  <text class = "data-entry to-black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</text>
                  <input type="text" name="project-category3" class = "searchbar to-black" id = "project-category3">
                  <br>
                  <text class = "data-entry to-black">Project Description:  </text>
                  <input type="text" name="project-description" class = "searchbar to-black" id = "project-description">
                  <br>
                  <br>
            ...
            <div class="modal-content modal-custom">
              ...
              <div class="modal-body">
                <form action="login.php" method="post">
                  ...
                  <br>
                  <br>
                  <input type ="hidden" name = "url" value ="advanced-search.php" id = "url">
                  <input type="submit" class="own-project-button">
                </form>
              </div>
